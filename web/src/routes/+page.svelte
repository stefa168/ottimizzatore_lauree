<script lang="ts">
    ...
    import MdiCupboard from '~icons/mdi/cupboard'
...
<!--<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ottimizzatore Lauree</span>
        </a>
        &lt;!&ndash; Is a navbar button necessary if the screen is too small? (smartphone)&ndash;&gt;
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="https://flowbite.com" class="flex items-center ms-2 md:me-24">
                    ...
                    <!--                    <MdiClipboardList class=" h8 me-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>-->
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Ottimizzatore Lauree</span>
                </a>
            </div>
        </div>
    </div>
