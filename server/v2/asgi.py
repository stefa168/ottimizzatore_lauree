...
from v2.domain.grad_sessions.controllers import GraduationSessionController, StudentController, ProfessorController

base_router = Router(
    path="/api/v1",
    route_handlers=[GraduationSessionController, StudentController, ProfessorController],
)
